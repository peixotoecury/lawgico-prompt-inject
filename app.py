...
with st.sidebar:
    ...
    <style>
      ...
      .logo-tag{position:absolute;top:-14px;right:0;font-size:10px;font-weight:900;color:#fff;letter-spacing:2px;white-space:nowrap;-webkit-font-smoothing:antialiased;-webkit-text-stroke:0.4px #fff;}
      .logo-sub{font-size:9px;font-weight:900;color:#fff;letter-spacing:3px;text-transform:lowercase;margin-top:5px;-webkit-font-smoothing:antialiased;-webkit-text-stroke:0.4px #fff;}
