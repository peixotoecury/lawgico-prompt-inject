...
with st.sidebar:
    ...
    <style>
      ...
      .logo-tag{position:absolute;top:-14px;right:0;font-size:10px;font-weight:400;color:#fff;letter-spacing:2px;white-space:nowrap;}
      .logo-sub{font-size:9px;font-weight:400;color:#fff;letter-spacing:3px;text-transform:lowercase;margin-top:5px;}
